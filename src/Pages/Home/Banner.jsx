          ...
          <SwiperSlide>
            <div className="hero-content px-5 lg:px-10 xl:px-0 2xl:max-w-screen-2xl flex-col-reverse md:flex-row-reverse">
              <div
                ...
                className="pt-20 lg:w-3/6 lg:max-w-lg "
              >
                <img src={slide1} />
              </div>
              <div
                data-aos="fade-up-right"
                className="lg:w-3/5 mr-auto text-center"
              >
                <h1 className="text-4xl lg:text-7xl text-center font-bold text-gray-900">
                ...
                <div className="flex justify-center gap-5">
                  ...
                  {user ? (
                    ...
                    <button
                      onClick={handleAlert}
                      className="px-5 py-3 border-0 rounded-lg text-lg font-semibold hover:bg-rose-600 bg-transparent outline outline-red-600 text-black hover:duration-100 hover:ease-in hover:text-white"
                    >
                      Add Recipe
                    </button>
                  )}

...
const Users = () => {
  ...
  return (
    <div>
      <h2 className=" text-4xl py-10 font-semibold text-rose-600 text-center">
        Our Happy Users
      </h2>
      <div className="carousel carousel-center flex-col md:flex-row items-center rounded-box">
        <div className="carousel-item">
          ...
          >
            <img
              className="h-52 w-52  rounded-full border-4 border-rose-600"
        ...
        <div className="carousel-item">
          <div
            data-aos="flip-left"
            className="flex flex-col items-center pr-10 py-10 "
          >
            <img
              className="h-52 w-52  rounded-full border-4 border-rose-600"
